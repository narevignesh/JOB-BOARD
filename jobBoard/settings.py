...
#         'HOST': '127.0.0.1',  # e.g., '127.0.0.1' or 'your-db-server.database.windows.net'
#         'PORT': '1433',  # Default port for SQL Server
#         'OPTIONS': {
#             'driver': 'ODBC Driver 17 for SQL Server',  # Ensure this matches the driver installed on your system
#         },
#     }
# }
